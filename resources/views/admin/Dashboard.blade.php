...
@section('content')
   ...
   <div class="lg:py-16 max-w-7xl mx-auto mt-8">
      ...
      <div class="flex w-full flex-row mb-4 justify-between">
         ...
         <a class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600 font-bold " href="{{ route('produk.create') }}">Create Post</a>
      </div>
      {{-- Tabel Produk --}}
      ...
      <div class="flex lg:mt-8 w-full flex-row mb-4 justify-between">
         ...
         <a class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600 font-bold " href="{{ route('review.create') }}" target="_blank">Create Review</a>
      </div>
      {{-- Tabel Review --}}
      <div class="flex flex-col">
         <div class="overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
