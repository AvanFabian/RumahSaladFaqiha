   ...
   <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <div
         ...
         <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" method="POST" action="{{ route('admin.register.submit') }}">
                @csrf
               <div>
                  ...
                  <input type="username" name="username" id="username"
                     ...
                     placeholder="adminfaqiha1" required />
               </div>
               <div>
               ...
               <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                  sudah punya akun? <a href="{{ route('admin.login') }}"
                     className="font-medium text-primary-600 hover:underline dark:text-primary-500">masuk disini</a>
               </p>
            </form>
         </div>
      </div>
