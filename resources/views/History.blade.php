...
@section('content')
   <!-- component -->
   <div class="sm:px-6 mt-10 lg:mt-7 w-full">
                  ...
                  <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                     ...
                     <td class="">
                        <div class="flex items-center pl-5">
                           <p class="text-base font-medium leading-none text-gray-700 mr-2">Marketing Keynote Presentation
                           </p>
                     ...
                     <td class="pl-5">
                        <button
                           class="py-3 px-3 text-sm focus:outline-none leading-none text-red-700 bg-red-100 rounded">12 April 23</button>
                     </td>
                     <td class="pl-4">
                        <button
